...
class WorkerTestCase(unittest.TestCase):
    ...
    def _worker(self, tube, tube_side, exists_return, exists_side_effect, get_redirect_history_from_task_return):
        parent_pid = 33
        config = mock.MagicMock()
        with mock.patch('source.lib.worker.get_tube', mock.Mock(return_value=tube, side_effect=tube_side)), \
                mock.patch('os.path.exists', mock.Mock(return_value=exists_return, side_effect=exists_side_effect)),\
    ...
    def test_worker_parent_is_dead(self):
        ...
        mocks = self._worker(tube, [input_tube, output_tube], is_path_exists, None, None)
    ...
    def test_worker_task_is_none(self):
        ...
        mocks = self._worker(tube, None, None, (True, False), mock.Mock())
    ...
    def test_worker_result_is_none(self):
        ...
        input_tube = mock.MagicMock()
        output_tube = mock.MagicMock()
        mocks = self._worker(tube, [input_tube, output_tube], None, (True, False), None)
    ...
    def test_worker_result_useragent(self):
        ...
        input_tube = mock.MagicMock()
        output_tube = mock.MagicMock()
        mocks = self._worker(tube, [input_tube, output_tube], None, (True, False), ['useragent', 'data'])
    ...
    def test_worker_result_not_useragent(self):
        ...
        input_tube = mock.MagicMock()
        output_tube = mock.MagicMock()
        mocks = self._worker(tube, [input_tube, output_tube], None, (True, False), [None, 'data'])
    ...
    def test_worker_not_result_database_error(self):
        ...
        mocks = self._worker(tube, None, None, (True, False), None)
